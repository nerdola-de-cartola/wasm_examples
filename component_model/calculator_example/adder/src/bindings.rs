  ...
  pub mod docs {
    pub mod adder {
      ...
      pub mod add {
        ...
        pub unsafe fn _export_add_cabi<T_: Guest>(arg0: i32,arg1: i32,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result0 = {
          T_::add(arg0 as u32, arg1 as u32)
        };
        _rt::as_i32(result0)
      } }
      pub trait Guest {
      ...
      macro_rules! __export_docs_adder_add_0_1_0_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          #[unsafe(export_name = "docs:adder/add@0.1.0#add")]
          unsafe extern "C" fn export_add(arg0: i32,arg1: i32,) -> i32 {
            unsafe { $($path_to_types)*::_export_add_cabi::<$ty>(arg0, arg1) }
          }
        };);
      }
      #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.53.1:docs:adder@0.1.0:adder:encoded world")]
#[doc(hidden)]
...
oducers\x01\x0cprocessed-by\x02\x0dwit-component\x070.245.1\x10wit-bindgen-rust\x06\
0.53.1";
